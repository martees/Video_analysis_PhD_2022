    ...
    for _ in range(len(what_to_plot)):
        ...
        for i_curve in range(len(conditions_each_curve)):
            ...
            if "total_visit_time" in what_to_plot:
                ...
                plots.plot_selected_data(result_table, "OD=" + param.nb_to_density[current_conditions[0]],
...
if __name__ == "__main__":
    ...
    # path = gr.generate(starting_from="", custom_path="E:/Alid_hard_drive_20241122/Results_minipatches_retracked/") # This works on my desktop at the lab
    path = gr.generate(starting_from="", custom_path="../")
    ...
    # converting_folder_names.switch_path(custom_path="E:/Alid_hard_drive_20241122/Results_minipatches_retracked/") # This works on my desktop at the lab
    converting_folder_names.switch_path(custom_path="../") 
