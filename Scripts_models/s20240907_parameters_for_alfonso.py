...
from Parameters.parameters import name_to_nb
...
for i_condition, condition_name in enumerate(condition_names):
    ...
    for i_folder, folder in enumerate(folder_list):
        ...
        current_visits, current_transits = ana.hard_cut_events(current_visits, current_transits)

        if type(current_visits) is list and type(current_transits) is list:
