...
nb_of_visit_bins = [1, 3, 9, 18, 120, 300]  # note: the code bug if there's a value superior to the last bin
...
for i_curve, current_curve_name in enumerate(curve_list):
    ...
    # Then, average and bootstrap for this condition
    ...
    plt.plot(bin_with_values, average_each_bin_this_cond,
             ...
             label=current_curve_name, linewidth=2)
