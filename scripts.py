...
for i_cond in param.nb_to_name.keys():
    plots.trajectories_1condition(trajectories, i_cond, plot_speed=True, plot_continuity=True, is_plot_patches=True, is_plot=False, save_fig=True)
